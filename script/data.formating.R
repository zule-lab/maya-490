...
write.csv(m.SLL.sp.table, file="output/m.SLL.sp.table.csv")
...
write.csv(m.ETF.sp.mat, file="output/m.ETF.sp.mat.csv")
...
write.csv(res.SLL.sp.mat, file="output/res.SLL.sp.mat.csv")
...
write.csv(res.ETF.sp.mat, file="output/res.ETF.sp.mat.csv")
...
write.csv(ins.SLL.sp.mat, file="output/ins.SLL.sp.mat.csv")
...
write.csv(ins.ETF.sp.mat, file="output/ins.ETF.sp.mat.csv")
...
write.csv(parks.SLL.sp.mat, file="output/parks.SLL.sp.mat.csv")
...
write.csv(parks.ETF.sp.mat, file="output/parks.ETF.sp.mat.csv")
...
write.csv(s.SLL.sp.mat, file="output/s.SLL.sp.mat.csv")
...
write.csv(s.ETF.sp.mat, file="output/s.ETF.sp.mat.csv")
...
write.csv(a.SLL.sp.mat, file="output/a.SLL.sp.mat.csv")
...
write.csv(a.ETF.sp.mat, file="output/a.ETF.sp.mat.csv")
